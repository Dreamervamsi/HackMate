from config import client, MODEL_NAME, GITHUB_TOKEN, GITHUB_DEFAULT_BRANCH, rate_limit_decorator, get_chat_history, add_to_chat_history, clear_chat_history
import subprocess
import json
import re
...
def create_agent(agent_name: str, description: str, system_instruction: str):
    ...
    add_to_chat_history(agent_name, "system", system_instruction)
...
def generate_agent_plan(agent_name: str, instruction_prompt: str):
    ...
    print(agent_name)
    agent_config = active_agents[agent_name]
    
    # Get chat history
    messages = get_chat_history(agent_name)
    ...
    try:
        ...
        add_to_chat_history(agent_name, "assistant", response_text)
...
def check_agent_plan_conflict(task_prompt: str, implementation_plan: str):
    ...
    If the plan is clear and conflict-free, return a pass verdict.
        ...
        return {
            ...
            "conflict_analysis": response_text
        }
    except Exception as e:
...
def conflict_resolver(task_prompt: str, summary: str, conflicts: list):
    try:
        ...
        # Add assistant response to chat history
        add_to_chat_history(agent_name, "assistant", raw)
...
def implement_plan(agent_name: str, implementation_plan: str):
    ...
    return {
        ...
        "implementation_result": response_text
    }
